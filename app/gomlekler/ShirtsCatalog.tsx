...
const SHIRTS: Shirt[] = [
  ...
  },
  {
    ...
    meta: ["Çizgili popeline", "Klasik"],
    swatches: ["#dde5ec", "#c2cbd2"],
    label: "Fotoğraf · Riga Azzurra · ¾",
    qv: {
      name: (<>Riga <em>Azzurra</em></>),
      num: "N° 02 · FW26",
      copy: "İnce mavi şerit, beyaz popeline üzerine. Klasiğin biraz daha hafif kuzeni. Pazartesi sabahları için.",
      fabric: "Popeline çizgili · 100/2",
      collar: "Klasik · 7cm",
      button: "Sedef · 11mm",
      made: "Sonbahar–Kış 26",
      tone: "cool",
  ...
  },
  {
    ...
    meta: ["Popeline · Gece mavisi", "Akşam"],
